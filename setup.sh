...
source $DIR/.env
export UNIFIER_EXTERNAL_PORT UNIFIER_INTERNAL_PORT ARCHSTOR_INTERNAL_PORT QREMIS_API_INTERNAL_PORT ACC_IDNEST_INTERNAL_PORT DEAD_SIMPLE_INTERFACE_INTERNAL_PORT UNIFIER_HOST REC_API_INTERNAL_PORT
