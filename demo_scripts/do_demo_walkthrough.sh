...
echo "$EXPLANATORY $ docker-machine ssh manager1 \"cd microservice_repository_orchestration && bash clone_repos.sh\""
echo "$EXPLANATORY Hit Enter to Execute the Command"
read
...
echo "$EXPLANATORY $ docker-machine ssh manager1 \"cd microservice_repository_orchestration && bash build_swarm_yml.sh\""
echo "$EXPLANATORY Hit Enter to Execute the Command"
read
